...
#Heatmap of top 10 most upregulated and top 10 most downregulated significant genes (???)
...
#Make sure the DESeq function collects result data to make heatmaps 
#Create heatmaps for each timepoint top 10 results
